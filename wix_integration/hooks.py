...
# Document Events - disabled for initial installation
# doc_events = {
#	"Item": {
...
# Scheduled Tasks - disabled for initial installation
# scheduler_events = {
#	"cron": {
#		"*/5 * * * *": [
...
# Boot Session - disabled for initial installation
# boot_session = "wix_integration.boot.boot_session"

# Website context - disabled for initial installation  
# website_context = {
